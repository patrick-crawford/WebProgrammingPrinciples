...
module.exports = {
  ...
  tagline: 'Course Notes for Web Programming Principles',
  url: 'https://patrick-crawford.github.io',
  baseUrl: '/WebProgrammingPrinciples',
  trailingSlash: false,
  onBrokenLinks: 'warn',
  onBrokenMarkdownLinks: 'warn',
  favicon: 'img/favicon.ico',
  organizationName: 'SDDS',
  projectName: 'WebProgrammingPrinciples',
  themeConfig: {
    navbar: {
      title: 'Web Programming Principles',
      logo: {
      ...
      links: [
        {
          ...
          items: [
            ...
            {
              html: `<a href='./pdf/WebProgrammingPrinciples.pdf' id='download-pdf' class='footer__link-item' download='WebProgrammingPrinciples.pdf'>Download Notes (PDF)</a>`,
            },
          ],
        },
      ],
